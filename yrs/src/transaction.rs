...
pub struct TransactionMut<'doc> {
    ...
    pub(crate) changed: HashMap<TypePtr, HashSet<Option<StringType>>>,
...
impl<'doc> TransactionMut<'doc> {
    ...
    pub(crate) fn add_changed_type(&mut self, parent: BranchPtr, parent_sub: Option<StringType>) {
...
pub struct RootRefs<'doc>(std::collections::hash_map::Iter<'doc, StringType, Box<Branch>>);
